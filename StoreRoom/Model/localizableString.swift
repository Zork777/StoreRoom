...
//  StoreRoom
//
//  Created by Евгений Захаров on 20.11.2022.
//
...
let notFoundIdRoomBox = NSLocalizedString("notFoundIdRoomBox", value: "id room or box is null", comment: "id room or box is null")
let failedBackupBase = NSLocalizedString("failedBackupBase", value: "failed backup base", comment: "failed backup base")
let failedRestoreBase = NSLocalizedString("failedRestoreBase", value: "failed restore base", comment: "failed restore base")
